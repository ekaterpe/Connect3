  ...
  return (
    <div className="max-w-lg mx-auto p-6 space-y-6">
      ...
      <div className="bg-white rounded-3xl p-6 shadow-lg border-2 border-purple-100">
        <h1 className="text-4xl font-bold text-gray-800">Reminders</h1>
        <p className="text-xl text-gray-600 mt-2">Today's medications</p>
        <div className="mt-4 flex items-center gap-3 text-2xl text-purple-600">
